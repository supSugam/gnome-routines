...
export class DisplayAdapter {
            ...
            try {
                ...
                proc.communicate_utf8_async(null, null, (proc: any, res: any) => {
                    try {
                        ...
                        debugLog(
                            '[DisplayAdapter] Failed to set refresh rate phase 1:',
                            e
                        );
                    }
                    resolve();
            ...
            try {
                ...
                proc.communicate_utf8_async(null, null, (proc: any, res: any) => {
                    try {
                        ...
                        debugLog(
                            '[DisplayAdapter] Failed to get refresh rate async:',
                            e
                        );
                        resolve(60);
                    }
    ...
    getAvailableRefreshRates(): Promise<number[]> {
        return new Promise((resolve) => {
            try {
                ...
                debugLog(
                    '[DisplayAdapter] Failed to initiate get available rates:',
                    e
                );
                resolve([60]);
            }
    ...
    setKeyboardBrightness(percentage: number): void {
        debugLog(
            `[DisplayAdapter] Setting keyboard brightness to: ${percentage}%`
        );
        try {
            ...
            Gio.DBus.session.call(
                ...
                (connection: any, res: any) => {
                    try {
                        ...
                        debugLog(
                            `[DisplayAdapter] Keyboard brightness set to ${value}%`
                        );
                    } catch (e) {
                        debugLog(
                ...
                Gio.DBus.session.call(
                    ...
                    (connection: any, res: any) => {
                        try {
                            ...
                            debugLog(
                                `[DisplayAdapter] Got keyboard brightness: ${value}%`
                            );
                            resolve(value);
                        } catch (e) {
                            debugLog(
