export const UI_STRINGS = {
  ...
  clipboard: {
    ...
    sanitizeMode: 'Sanitization Mode',
    modes: {
      predefined: 'Predefined Only',
    ...
    ruleDomain: 'Domain Pattern',
    ruleDomainPlaceholder: '*.example.com/*',
    ruleParams: 'Parameters',
    ruleParamsPlaceholder: 'utm_source, ref, ...',
    editRule: 'Edit Rule',
    addRuleTitle: 'Add Domain Rule',
    find: 'Find (Regex)',
